        ...
        it("The user with the same username cannot be inserted into the DB", (done) => {
            ...
            chai.request(server)
                ...
                .end((err, res) => {
                    res.body.should.be.a('object');
                    res.body.should.have.property('message');
                    res.body.should.have.property('message').equal('Username already exists');
        ...
        it("The username, password, and email cannot be empty", (done) => {
            ...
            chai.request(server)
                ...
                .end((err, res) => {
                    res.body.should.be.a('object');
                    res.body.should.have.property('message');
                    res.body.should.have.property('message').equal('Username, password, and email cannot be empty');
                    res.body.should.have.property('status');
                    res.body.should.have.property('status').equal('err');
                    done();
                })
